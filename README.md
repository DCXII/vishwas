...
- Blockchain Integration: Hyperledger Fabric for immutable record keeping
...
curl -X POST http://localhost:5000/api/users/register   -H "Content-Type: application/json"   -d '{"name":"Test User","email":"test@example.com","password":"testpass","role":"patient"}'
