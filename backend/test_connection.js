...
async function main() {
    try {
        ...
        if (!fs.existsSync(ccpPath)) {
            console.error(`Error: ccpPath ${ccpPath} does not exist`);
            return;
        }
        ...
        // Assuming chaincode name is 'basic' or 'vishwas'
        // We will try 'basic' first as per tutorial, or check deployCC
